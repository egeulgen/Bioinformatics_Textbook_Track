...
def middle_edge(str1, str2, top=0, bottom=None, left=0, right=None):
    ...
    if idx2 == idx + 1:
        return (idx + top, mid_col), (idx + top + 1, mid_col + 1)
    if idx2 == idx:
        return (idx + top, mid_col), (idx + top, mid_col + 1)
    return (idx + top, mid_col), (idx + top + 1, mid_col)
...
if __name__ == "__main__":
    ...
    mid_edge_from, mid_edge_to = middle_edge(string1, string2)
